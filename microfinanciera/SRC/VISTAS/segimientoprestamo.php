...
<head>
    ...
    /* Modifica el estilo del encabezado de la tabla "Seguimiento del préstamo" */
    .table th[scope="col"] {
        background-color: transparent;
        color: #2E78F9; /* Cambia el color de las letras a azul */
    }
    
    /* Define el estilo del botón CANCELAR en rojo */
    .btn-cancelar {
...
<body>
    <div class="row">
        ...
        <main class="col">
            ...
            <!-- Agrega la tabla -->
            <table class="table" style="background-color: #7D91F7;">
                <thead>
                    <tr>
                        <H2 style="background-color: transparent; color: #2E78F9;" colspan="8">Seguimiento del préstamo</H2>
                    </tr>
                    <tr>
                        <th>Buscar</th>
                        <td><input type="text" id="busqueda" placeholder="Ingrese dato y presione Enter"></td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div class="text-center">
                ...
                <button class="btn btn-cancelar">CANCELAR</button> <!-- Aplicamos la clase btn-cancelar para hacerlo rojo -->
            </div>
        </main>
    </div>
