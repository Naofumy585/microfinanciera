    ...
    <div class="row">
       ...
       <nav class="navbar bg-body-tertiary" style="background: none; border: none;">
        ...
        <main class="col">
            ...
            <!-- A partir de aquí, se encuentra la tabla y los botones con las modificaciones solicitadas -->
            <div class="container mt-4">
                <h2 style="color: #2E78F9;">REGISTRAR UN NUEVO CLIENTE</h2>
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    <tr style="background-color: #2E78F9; color: #FFF;">
                        <td colspan="8">INGRESAR DATOS </td>
                    </tr>
                    <tr>
                        <td>Ingresa ID:</td>
